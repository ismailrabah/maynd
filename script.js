/**
 * Maynd.ma - Multilingual Landing Page
 */
...
const T = {
  ar: {
    ...
    testimonials: ['آراء العملاء','ما يقوله عملاؤنا',""Maynd غير طريقة عملنا تماماً. الآن يمكننا معالجة الفواتير في ثوانٍ."",""الحل المثالي للمكاتب الطبية. بيئة آمنة بدون تسريب البيانات."",""استخدام Maynd جعلنا أكثر كفاءة."",'أحمد بن علي','أحمد بن علي, مكتب محاسبي','فاطمة الزهراء','فاطمة الزهراء, عيادة طبية','محمد اليازيدي','محمد اليازيدي, مكتب قانوني'],
    ...
    contact: ['اتصل بنا','نحن هنا لمساعدتك','الهاتف','البريد الإلكتروني','العنوان','الرباط، المغرب','sales@maynd.ma','+212 5 37 77 00 00','اطلب استشارة مجانية','الاسم الكامل','اسم الشركة','البريد الإلكتروني','رقم الهاتف','القطاع','الرسالة','إرسال الطلب','شكراً لك! تم استلام طلبك.','حدث خطأ. يرجى المحاولة مرة أخرى.'],
  ...
  fr: {
    ...
    testimonials: ['Témoignages','Ce que disent nos clients',""Maynd a transformé notre façon de travailler."",""La solution idéale pour les cabinets médicaux."",""Maynd nous a rendus plus efficaces."",'Ahmed Ben Ali','Ahmed Ben Ali, Cabinet comptable','Fatima Zahra','Fatima Zahra, Clinique médicale','Mohamed Yazidi','Mohamed Yazidi, Cabinet juridique'],
    ...
    contact: ['Contactez-nous','Nous sommes là pour vous aider','Téléphone','Email','Adresse','Rabat, Maroc','sales@maynd.ma','+212 5 37 77 00 00','Demander une consultation gratuite','Nom complet','Nom de l'entreprise','Adresse email','Numéro de téléphone','Secteur','Message','Envoyer la demande','Merci ! Votre demande a été reçue.','Une erreur est survenue.'],
  ...
  en: {
    ...
    testimonials: ['Testimonials','What Our Clients Say',""Maynd transformed our workflow."",""The ideal solution for medical practices."",""Maynd made us more efficient."",'Ahmed Ben Ali','Ahmed Ben Ali, Accounting Firm','Fatima Zahra','Fatima Zahra, Medical Clinic','Mohamed Yazidi','Mohamed Yazidi, Law Firm'],
    ...
    contact: ['Contact Us','We are here to help you','Phone','Email','Address','Rabat, Morocco','sales@maynd.ma','+212 5 37 77 00 00','Request a Free Consultation','Full Name','Company Name','Email Address','Phone Number','Sector','Message','Send Request','Thank you! Your request has been received.','An error occurred. Please try again.'],
